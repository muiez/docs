---
title: 'LangChain'
description: 'Build LangChain agents with persistent memory using LeedAB'
icon: 'link'
---

## Overview

Integrate LeedAB with LangChain to create agents that maintain conversation history and can access long-term memory across sessions.
...
Define LangChain tools that interact with LeedAB:
...
Create a custom LangChain memory class that uses LeedAB:
...
class AgentMindMemory(BaseMemory):
    """Custom LangChain memory backed by LeedAB"""
    ...
    def save_context(self, inputs: Dict[str, Any], outputs: Dict[str, str]) -> None:
        """Save conversation turn to LeedAB"""
    ...
    def load_memory_variables(self, inputs: Dict[str, Any]) -> Dict[str, Any]:
        """Load relevant context from LeedAB"""
