---
title: 'OpenAI'
description: 'Use LeedAB with GPT models via function calling'
icon: 'brain'
---

## Overview

This example shows how to give your OpenAI-powered agent the ability to remember and recall information using function calling with LeedAB.
...
def handle_remember(content: str, category: str = "other", importance: float = 0.5):
    """Store information using LeedAB"""
    try:
...
def handle_recall(query: str, category: str = None):
    """Retrieve information from LeedAB"""
