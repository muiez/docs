---
title: 'Smolagents'
description: 'Use LeedAB as a tool with HuggingFace Smolagents'
icon: 'toolbox'
---

## Overview

Integrate LeedAB with HuggingFace's Smolagents framework using the `@tool` decorator to give your agents persistent memory capabilities.
...
Define LeedAB tools using the `@tool` decorator:
