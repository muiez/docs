...
url = "https://api.leedab.com/api/v1/memories/forget"
headers = {
...
```bash cURL
curl -X POST https://api.leedab.com/api/v1/memories/forget \
...
const response = await fetch('https://api.leedab.com/api/v1/memories/forget', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer YOUR_API_KEY',
    'Content-Type': 'application/json'
