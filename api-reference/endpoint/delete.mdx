...
url = f"https://api.leedab.com/api/v1/memories/delete/{memory_id}"
headers = {
...
```bash cURL
curl -X DELETE https://api.leedab.com/api/v1/memories/delete/mem_abc123 \
  -H "Authorization: Bearer YOUR_API_KEY"
```

```javascript JavaScript
const memoryId = "mem_abc123";
const response = await fetch(`https://api.leedab.com/api/v1/memories/delete/${memoryId}`, {
  method: 'DELETE',
  headers: {
    'Authorization': 'Bearer YOUR_API_KEY'
  }
